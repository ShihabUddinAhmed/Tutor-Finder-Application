...
import java.sql.*;
 public class SignUpP extends JFrame implements ActionListener
 {
	 ...
	 private JTextField name, email, institution, contact, address, prefferedSub, qualification;
	 ...
	 public SignUpP()
	 {
		 ...
		 l1= new Label("Registration For Professional Teachers: ");
		 ...
		 // l5= new Label("Institution     :");
		 // l5.setFont(f1);
		 // l5.setBounds(65,150,158,50);
		 ...
		 address.setFont(f1);
		 // institution= new JTextField(10);
		 // institution.setBounds(308,160,320,30);
		 // institution.setFont(f1);
		 prefferedSub= new JTextField(20);
		 prefferedSub.setBounds(308,160,320,30);
		 prefferedSub.setFont(f1);
		 qualification= new JTextField(15);
		 qualification.setBounds(308,310,320,30);
		 qualification.setFont(f1);
		 password=new JPasswordField(50);
		 password.setBounds(308,360,320,30);
		 password.setFont(f1);
		 password.setEchoChar('\u26AB');
		 passwordC=new JPasswordField(50);
		 passwordC.setBounds(308,410,320,30);
		 passwordC.setFont(f1);
		 passwordC.setEchoChar('\u26AB');
		 add(l1);add(j1);add(l);add(l2);add(j);add(l3);add(name);add(password);add(l4);add(l6);add(l7);add(l8);add(email);add(contact);add(address);add(passwordC);add(l9);add(l10);add(prefferedSub);add(qualification);
		 setLayout(null);
		 setLocation(525,300);
	 ...
	 public void actionPerformed(ActionEvent e)
	 {
		 ...
		 else if(sig.equals("Register"))
		 {
			 ...
			 String sql="INSERT INTO `professional` (`PROFESSIONAL_NAME`,`PHONE_NUMBER`,`QUALIFICATION`,`PREFERRED_SUBJECT`) VALUES ('"+name.getText()+"','"+contact.getText()+"','"+qualification.getText()+"','"+prefferedSub.getText()+"');";
			 ...
			 if(w.equals(w1))
			 {
				 try
				 {
					 ...
					 while(rSet.next())
					 {
						 ...
						 if(q2.equals(q3))
						 {
							 sql="INSERT INTO `professional` (`PROFESSIONAL_NAME`,`PHONE_NUMBER`,`QUALIFICATION`,`PREFERRED_SUBJECT`, `ADDRESS_ID`) VALUES ('"+name.getText()+"','"+contact.getText()+"', '"+qualification.getText()+"','"+prefferedSub.getText()+"','"+rSet.getString("ADDRESS_ID")+"');";
						 }
					 ...
					 u=da.ddlOperation(sql);
						 String sq="SELECT * FROM `professional` WHERE `PROFESSIONAL_NAME` LIKE '"+name.getText()+"' AND `PHONE_NUMBER` LIKE '"+contact.getText()+"'";
						 ResultSet rSet1=da.getProduct(sq);
						 String sq1=" ";
						 while(rSet1.next())
						 {
							 sq1=rSet1.getString("PROFESSIONAL_ID");
						 }
						 String sql1="INSERT INTO `account` (`EMAIL`, `PASSWORD`, `ACCOUNT_TYPE`, `STUDENT_ID`, `FREELANCER_ID`, `INSTITUTION_ID`, `PROFESSIONAL_ID`) VALUES ('"+email.getText()+"', '"+w+"', 'professional', NULL, NULL, NULL,'"+sq1+"');";
