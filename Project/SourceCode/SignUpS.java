...
import java.sql.*;
 ...
 {
	 private Label l,l1,l2,l3,l4,l5,l6,l7,l8;
	 private JTextField name, email, cls, contact, address;
	 ...
	 private Button j,j1;
	 //private String n=" ",n1=" ",n2=" ",n3=" ",n4=" ",n5=" ",n6=" ",;
	 public SignUpS()
	 {
		 ...
		 l1= new Label("Registration For Students: ");
		 ...
		 password.setBounds(308,310,320,30);
		 password.setFont(f1);
		 password.setEchoChar('\u26AB');
		 passwordC=new JPasswordField(50);
		 passwordC.setBounds(308,360,320,30);
		 passwordC.setFont(f1);
		 passwordC.setEchoChar('\u26AB');
		 add(l1);add(j1);add(l);add(l2);add(j);add(l3);add(name);add(password);add(l4);add(l5);add(l6);add(l7);add(l8);add(email);add(cls);add(contact);add(address);add(passwordC);
		 setLayout(null);
		 setLocation(525,300);
	 ...
	 public void actionPerformed(ActionEvent e)
	 {
		 ...
		 else if(sig.equals("Register"))
		 {
			 ...
			 String sql="INSERT INTO `student` (`STUDENT_NAME`, `CLASS`, `PHONE_NUMBER`) VALUES ('"+name.getText()+"', '"+cls.getText()+"', '"+contact.getText()+"');";;
				 ...
				 if(w.equals(w1))
				 {
					 try
					 {
						 ...
						 while(rSet.next())
						 {
							 ...
							 if(q2.equals(q3))
							 {
								 sql="INSERT INTO `student` (`STUDENT_NAME`, `CLASS`, `PHONE_NUMBER`, `ADDRESS_ID`) VALUES ('"+name.getText()+"', '"+cls.getText()+"', '"+contact.getText()+"', '"+rSet.getString("ADDRESS_ID")+"');";
							 }
						 ...
						 u=da.ddlOperation(sql);
							 String sq="SELECT * FROM `student` WHERE `STUDENT_NAME` LIKE '"+name.getText()+"' AND `CLASS` LIKE '"+cls.getText()+"' AND `PHONE_NUMBER` LIKE '"+contact.getText()+"'";
							 ResultSet rSet1=da.getProduct(sq);
							 String sq1=" ";
							 while(rSet1.next())
							 {
								 sq1=rSet1.getString("STUDENT_ID");
							 }
							 String sql1="INSERT INTO `account` (`EMAIL`, `PASSWORD`, `ACCOUNT_TYPE`, `STUDENT_ID`, `FREELANCER_ID`, `INSTITUTION_ID`, `PROFESSIONAL_ID`) VALUES ('"+email.getText()+"', '"+w+"', 'student', '"+sq1+"', NULL, NULL, NULL);";
