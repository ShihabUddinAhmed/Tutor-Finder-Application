...
import javax.swing.*;
import java.sql.*;
 public class ProfileF extends JFrame implements ActionListener
 {
	 ...
	 public ProfileF(String ID)
	 {
		 ...
		 try
		{
			...
			String sq="SELECT * FROM `account` WHERE `FREELANCER_ID` = "+ID;
			...
			{
				 IDS=rSet.getString("FREELANCER_ID");
				...
				catch(Exception ex)
				{
				 ...
				 s=rSet.getString("FREELANCER_NAME");
		...
		catch(Exception ex)
		{
		 ...
		 b8.setBounds(625,297,150,25);
		 b9= new Button("Edit Subject");
		 b9.setBounds(625,334,100,25);
		 add(l);add(b3);add(tf);add(b);add(l3);add(tf1);add(b1);add(l4);add(tf2);add(b2);add(l5);add(tf3);add(l2);add(b5);add(l6);add(tf4);add(b6);add(b7);add(l7);add(l8);add(tf5);add(tf6);add(b8);add(b9);
		 ...
		 {try
		 {
			 ...
			 if(sig.equals("Edit Name"))
			 {
				 ...
				 else
				 {
					 ...
					 i=du.ddlOperation("UPDATE `freelancer` SET `FREELANCER_NAME` = '"+inputValue+"' WHERE `freelancer`.`FREELANCER_ID` = "+IDS+";");
				 if(i==1)
				 {
			 ...
			 else if(sig.equals("Edit Phone-Number"))
			 {
				 ...
				 {
				 i=du.ddlOperation("UPDATE `freelancer` SET `PHONE_NUMBER` = '"+inputValue+"' WHERE `freelancer`.`FREELANCER_ID` = "+IDS);
				 if(i==1)
				 {
					 JOptionPane.showMessageDialog(null,
								"Phone-Number Edited",
			 ...
			 else if(sig.equals("Edit Address"))
			 {
				 ...
				 try
				{
					...
					{
						 flag=true;
						 i=du.ddlOperation("UPDATE `freelancer` SET `ADDRESS_ID` = '"+rSet.getString("ADDRESS_ID")+"' WHERE `freelancer`.`FREELANCER_ID` = "+IDS);
						 if(i==1)
						 {
							 JOptionPane.showMessageDialog(null,
										"Address Edited",
				...
				catch(Exception ex)
				{
				 ...
				 else
				 {
					 ...
					 while(upResult.next())
					 {
						 i=du.ddlOperation("UPDATE `freelancer` SET `ADDRESS_ID` = '"+upResult.getString("ADDRESS_ID")+"' WHERE `freelancer`.`FREELANCER_ID` = "+IDS);
					 }
					 if(i==1)
					 {
						 JOptionPane.showMessageDialog(null,
			 ...
			 else if(sig.equals("Edit Qulification"))
			 {
				 ...
				 {
				 i=du.ddlOperation("UPDATE `freelancer` SET `QUALIFICATION` = '"+inputValue+"' WHERE `freelancer`.`FREELANCER_ID` = "+IDS);
				 if(i==1)
				 {
					 JOptionPane.showMessageDialog(null,
			 ...
			 else if(sig.equals("Edit Subject"))
			 {
				 ...
				 {
				 i=du.ddlOperation("UPDATE `freelancer` SET `PREFERRED_SUBJECT` = '"+inputValue+"' WHERE `freelancer`.`FREELANCER_ID` = "+IDS);
				 if(i==1)
				 {
					 JOptionPane.showMessageDialog(null,
								"Subject Edited",
